...
const modalVariants = cva(
  'fixed inset-0 flex items-center justify-center z-50 transition-all duration-300',
  {
    variants: {
      variant: {
        light:
          'bg-[var(--surface-color)] text-[var(--text-color)] shadow-2xl border border-[var(--border-color)]',
        dark: 'bg-[#262622] text-white shadow-2xl border border-[#514b45]',
        outline:
      ...
      <div className="fixed inset-0 flex items-center justify-center z-50">
        ...
        <Comp
          ...
          className={cn(
            ...
            'relative rounded-[32px] transform scale-100 transition-all duration-300 animate-fadeIn',
            className
          )}
          {...props}
        >
